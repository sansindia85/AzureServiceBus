...
namespace MSDNSampleApp
{
    class Program
    {
        static string connectionString = "Endpoint=sb://genixdeviampossb.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=SfucCAVAvPPDNK24UXC8TEVQ3q5axGp80EgyvSI4WNE=";
        ...
        static async Task Main()
        {
            ...
            // send a batch of message sto the queue
        ...
        static async Task ReceiveMessagesAsync()
        {
            await using (ServiceBusClient client = new ServiceBusClient(connectionString))
            {
                ...
                // add handle to process messages
        ...
        //handle any errors when receiving the messages
